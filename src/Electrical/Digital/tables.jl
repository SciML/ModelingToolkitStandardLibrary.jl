...
function Base.getindex(s::LogicTable, i1::Logic, i2::Logic)
    return getindex(s.logic, get_logic_level(i1), get_logic_level(i2))
end
function Base.getindex(
        s::LogicTable, i1::Logic, i2::Logic,
        I::Logic...
    )
    return getindex(s.logic, get_logic_level(i1), get_logic_level(i2), get_logic_level(I...)...)
end

getindex(s::LogicTable, l::Int) = getindex(s.logic, l)
function getindex(s::LogicTable, i1::Int, i2::Int, I::Int...)
    return getindex(s.logic, i1, i2, I...)
end

function Base.setindex!(A::LogicTable, x::Logic, i1::Int)
    return setindex!(A.logic, x, i1)
end
function Base.setindex!(A::LogicTable, x::Logic, i1::Int, i2::Int, I::Int...)
    return setindex!(A.logic, x, i1, i2, I...)
end
